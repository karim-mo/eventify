				...
				<>
					...
					{placeOrderPrompt && (
						<Modal show={placeOrderPrompt}>
							...
							<Modal.Body>
								Placing an order will clear your cart contents
								and you'll be redirected to Checkout to finish
								your payment process, If you wish to add or
								remove your cart contents, you may close this
								window and do so now.
							</Modal.Body>
							<Modal.Footer>
								<Button
									variant='secondary'
